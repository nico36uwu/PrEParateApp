...
namespace PrEParateApp.Utilities
{
    public class Constantes
    {
        ...
        public const string FRECUENCIA_MARTES = "Martes";
        public const string FRECUENCIA_MIERCOLES = "Miercoles";
        public const string FRECUENCIA_JUEVES = "Jueves";
        public const string FRECUENCIA_VIERNES = "Viernes";
